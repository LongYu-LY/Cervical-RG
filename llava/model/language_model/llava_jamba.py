...
from Jamba.modeling_jamba import JambaModel, JambaForCausalLM
...
class LlavaJambaForCausalLM(JambaForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.model = LlavaJambaModel(config)
...
AutoConfig.register("llava_jamba", LlavaJambaConfig)
AutoModelForCausalLM.register(LlavaJambaConfig, LlavaJambaForCausalLM)
