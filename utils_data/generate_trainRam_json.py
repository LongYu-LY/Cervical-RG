...
# 指定包含多个医院数据的主文件夹路径
main_folder_path = "/home/ly/LLMs/M3D/Data/hospital_data_3D/"
        ...
        with open(csv_file_path, 'r') as file:
            ...
            for row in csv_reader:
                ...
                for root, _, files in os.walk(image_folder_path):
                    ...
                    current_modality_images = [os.path.join(root, f) for f in files if f.lower().endswith(('t2a.npy', 't1ca.npy','adc.npy'))]
                    ...
                    selected_images = current_modality_images[0:5]
...
# 输出所有训练数据
output_json_path = "/home/ly/LLMs/LongLLaVA-3D/data/train_data_T2A_T1CA_ADC_all.json"
...
test_output_path = '/home/ly/LLMs/LongLLaVA-3D/data/test_data_3D.json'
