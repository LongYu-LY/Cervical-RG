        ...
        with open(csv_file_path, 'r') as file:
            ...
            for row in csv_reader:
                ...
                for root, _, files in os.walk(image_folder_path):
                    ...
                    current_modality_images = [os.path.join(root, f) for f in files if f.lower().endswith('.npy')]
...
# 输出所有训练数据
output_json_path = "/home/ly/LLMs/LongLLaVA-3D/data/train_data_3D_all.json"
